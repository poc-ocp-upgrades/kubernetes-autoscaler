...
func TestExtractRunOk(t *testing.T) {
	...
	var testCases = []struct {
		...
		testLine	string
		expect		bool
	}{{name: "basic", testLine: "=== RUN TestName", expect: true}, {name: "numeric", testLine: "=== RUN 1234", expect: true}, {name: "failed print", testLine: "some other text=== RUN TestName"}}
...
func TestExtractRunName(t *testing.T) {
	...
	var testCases = []struct {
		...
		testLine	string
		expectedName	string
	}{{name: "basic start", testLine: "=== RUN TestName", expectedName: "TestName"}, {name: "numeric", testLine: "=== RUN 1234", expectedName: "1234"}}
	for _, testCase := range testCases {
...
func TestExtractDuration(t *testing.T) {
	...
	var testCases = []struct {
		...
		fail			bool
	}{{name: "basic", testLine: "--- PASS: Test (0.10 seconds)", expectedDuration: "0.10s"}, {name: "go1.5.1 timing", testLine: "--- PASS: TestTwo (0.03s)", expectedDuration: "0.03s"}, {name: "failed print", testLine: "some other text--- PASS: TestTwo (0.03s)", expectedDuration: "0.03s", fail: true}}
	for _, testCase := range testCases {
...
func TestExtractSuiteName(t *testing.T) {
	...
	var testCases = []struct {
		...
		expectedName	string
		fail		bool
	}{{name: "basic", testLine: "ok  	package/name 0.160s", expectedName: "package/name"}, {name: "go 1.5.1", testLine: "ok  	package/name	0.160s", expectedName: "package/name"}, {name: "numeric", testLine: "ok  	1234 0.160s", expectedName: "1234"}, {name: "url", testLine: "ok  	github.com/maintainer/repository/package/file 0.160s", expectedName: "github.com/maintainer/repository/package/file"}, {name: "with coverage", testLine: `ok  	package/name 0.400s  coverage: 10.0% of statements`, expectedName: "package/name"}, {name: "failed print", testLine: `some other textok  	package/name 0.400s  coverage: 10.0% of statements`, expectedName: "package/name", fail: true}}
	for _, testCase := range testCases {
...
func TestSuiteProperties(t *testing.T) {
	...
	}{{name: "basic", testLine: `coverage: 10.0% of statements`, expectedProperties: map[string]string{coveragePropertyName: "10.0"}}, {name: "with package declaration", testLine: `ok  	package/name 0.400s  coverage: 10.0% of statements`, expectedProperties: map[string]string{coveragePropertyName: "10.0"}}, {name: "failed print", testLine: `some other textcoverage: 10.0% of statements`, expectedProperties: map[string]string{coveragePropertyName: "10.0"}}}
	for _, testCase := range testCases {
