...
type gceManagerMock struct{ mock.Mock }
...
func TestGetResourceLimiter(t *testing.T) {
	...
	gceManagerMock := &gceManagerMock{}
	resourceLimiter := cloudprovider.NewResourceLimiter(map[string]int64{cloudprovider.ResourceNameCores: 1, cloudprovider.ResourceNameMemory: 10000000}, map[string]int64{cloudprovider.ResourceNameCores: 10, cloudprovider.ResourceNameMemory: 100000000})
	gce := &GceCloudProvider{gceManager: gceManagerMock, resourceLimiterFromFlags: resourceLimiter}
...
func TestMig(t *testing.T) {
	...
	mig1 := &gceMig{gceManager: gceManagerMock, minSize: 0, maxSize: 1000}
	...
	gceManagerMock.On("GetMigNodes", mock.AnythingOfType("*gce.gceMig")).Return([]string{"gce://project1/us-central1-b/gke-cluster-1-default-pool-f7607aac-9j4g", "gce://project1/us-central1-b/gke-cluster-1-default-pool-f7607aac-dck1"}, nil).Once()
	...
	mock.AssertExpectationsForObjects(t, gceManagerMock)
	mig2 := &gceMig{gceRef: GceRef{Project: "project1", Zone: "us-central1-b", Name: "default-pool"}, gceManager: gceManagerMock, minSize: 0, maxSize: 1000}
